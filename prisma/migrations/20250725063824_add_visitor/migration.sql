...
CREATE TABLE "Hearing" (
    ...
    "verdict" TEXT,
    "caseId" INTEGER NOT NULL,
    "hearingTypeId" INTEGER NOT NULL,
...
CREATE TABLE "Efile" (
    ...
    CONSTRAINT "Efile_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "_BookingToVisitor" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_BookingToVisitor_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Courtroom_name_key" ON "Courtroom"("name");
...
-- CreateIndex
CREATE INDEX "_BookingToVisitor_B_index" ON "_BookingToVisitor"("B");
...
-- AddForeignKey
ALTER TABLE "Hearing" ADD CONSTRAINT "Hearing_hearingTypeId_fkey" FOREIGN KEY ("hearingTypeId") REFERENCES "HearingType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Activity" ADD CONSTRAINT "Activity_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "Booking"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Efile" ADD CONSTRAINT "Efile_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "Case"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Efile" ADD CONSTRAINT "Efile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_BookingToVisitor" ADD CONSTRAINT "_BookingToVisitor_A_fkey" FOREIGN KEY ("A") REFERENCES "Booking"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BookingToVisitor" ADD CONSTRAINT "_BookingToVisitor_B_fkey" FOREIGN KEY ("B") REFERENCES "Visitor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
